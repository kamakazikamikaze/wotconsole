...
def vlan_extract(oldconfig, newconfig, fullconfig=True):
    ...
    The user may specifiy if a full config is to be made or if only a list of VLANs is desired.
    ...
    fullconfig -- if true, a full configuration file is to be generated; if false, return only a list of VLANs (defaults to True)
